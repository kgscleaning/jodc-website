    ...
    <div className="relative isolate overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Professional cleaning services in action"
          fill
      ...
      <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-16 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
          <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Professional Cleaning Services Across GTA
          </h1>
          <p className="mt-6 text-lg leading-8 text-gray-100">
            Founded by an expert with 12 years of personal experience, we provide exceptional cleaning services to businesses and homes across the Greater Toronto Area. Trust us to maintain your space while you focus on what matters most.
          </p>
