...
export default function Footer() {
  const navigation = {
    ...
    services: [
      ...
      { name: 'Medical Facility Cleaning', href: '/services/medical-cleaning' },
      { name: 'Industrial Cleaning', href: '/services/industrial-cleaning' },
      { name: 'Retail Cleaning', href: '/services/retail-cleaning' },
    ],
    social: [
      {
        name: 'Instagram',
        href: 'https://instagram.com/jo.dc_cleaning_inc',
        icon: (props) => (
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              Professional commercial cleaning services in the Greater Toronto Area.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div>
              ...
              <dl className="mt-6 space-y-4 text-sm leading-6 text-gray-600">
                <div>
                  <dt className="font-semibold text-gray-900">Area Served</dt>
                ...
                <div>
                  ...
                  <dd>
                    <a href="mailto:jo.dc@jodccleaning.com" className="hover:text-primary">
                      jo.dc@jodccleaning.com
                    </a>
                  </dd>
                </div>
                <div>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">
            &copy; {new Date().getFullYear()} JO.DC Cleaning Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
